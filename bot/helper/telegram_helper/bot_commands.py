...
MediaInfoCommand = (f"mediainfo{i}", f"mi{i}")  # Fixed tuple syntax
...
RestartCommand = (f"restart{i}", f"r{i}")  # Fixed tuple syntax
...
BotSetCommand = (f"bsetting{i}", f"bs{i}")  # Fixed tuple syntax
UserSetCommand = (f"usetting{i}", f"us{i}")  # Fixed tuple syntax
